...
iomux_v3_cfg_t const uart1_pads[] = {
	...
	MX6_PAD_EIM_D25__UART1_DSR | MUX_PAD_CTRL(UART_PAD_CTRL),
	MX6_PAD_EIM_D24__UART1_DTR | MUX_PAD_CTRL(UART_PAD_CTRL),
	MX6_PAD_EIM_D23__UART1_DCD | MUX_PAD_CTRL(UART_PAD_CTRL),
	MX6_PAD_EIM_EB3__UART1_RI | MUX_PAD_CTRL(UART_PAD_CTRL),
};
...
iomux_v3_cfg_t const ecspi3_pads[] = {
	...
	MX6_PAD_DISP0_DAT5__GPIO_4_26 | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	MX6_PAD_GPIO_6__USDHC2_LCTL	| MUX_PAD_CTRL(USDHC_PAD_CTRL), /* CD */
};
...
static void setup_epdc_power(void)
{
	...
	imx_iomux_v3_setup_pad(MX6_PAD_EIM_D17__GPIO_3_17 |	MUX_PAD_CTRL(EPDC_PAD_CTRL));
